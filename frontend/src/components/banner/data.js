export const BANNER_BLOCK_12 = {
  href: "/store/landing/jul25twin",
  isSale: true,
  backgroundColor: "rgb(39, 39, 39)",
  widthSource: "600",
  heightSource: "70",
  srcset: "mobile_9.jpg 600w",
...
export const BANNER_BLOCK_19 = {
  href: "/store/landing/jul29mb",
  isSale: false,
  srcset: "mb_slider_mobile.jpg",
  media: "(max-width: 800px)",
...
export const MERCH_BANNER_2 = {
  href: "/store/brands/rule-1",
  isSale: false,
  srcset:
    "https://cdn.muscleandstrength.com/store/media/wysiwyg/Home_Slider/2022/05/r1_slider_mobile.jpg",
  media: "(max-width: 739px)",
